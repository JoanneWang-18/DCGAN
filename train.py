...
save_path = r"C:\Users\joann\Desktop\Python\dcgan_celeba"
...
optimizerD = optim.Adam(netD.parameters(), lr=0.0004, betas=(params['beta1'], 0.999))
optimizerG = optim.Adam(netG.parameters(), lr=0.0003, betas=(params['beta1'], 0.999))
